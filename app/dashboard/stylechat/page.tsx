...
export default function StyleChatPage() {
    ...
    return (
        <div className="h-[calc(100vh-4rem)] lg:h-[calc(100vh-3rem)] flex flex-col overflow-hidden">
            {/* Header */}
            <div className="shrink-0 p-4 md:p-6 lg:p-8 pb-0">
                <div className="max-w-3xl mx-auto">
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">StyleChat</h1>
                        <p className="text-sm text-muted-foreground">Your personal AI stylist</p>
                    </div>
                </div>
            </div>
            ...
            {/* Input Area */}
            <div className="shrink-0 p-4 md:p-6 lg:p-8 pt-0 bg-gradient-to-t from-background via-background to-transparent">
                <div className="max-w-3xl mx-auto">
