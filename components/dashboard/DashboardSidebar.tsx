...
import { FiGrid, FiScissors, FiCalendar, FiUsers, FiMessageCircle, FiBookmark, FiUser, FiCamera } from "react-icons/fi";
import { IconType } from "react-icons";
import { cn } from "@/lib/utils";

const sidebarLinks: { name: string; href: string; icon: IconType }[] = [
    { name: "Wardrobe", href: "/dashboard/wardrobe", icon: FiGrid },
    { name: "Studio", href: "/dashboard/studio", icon: FiCamera },
